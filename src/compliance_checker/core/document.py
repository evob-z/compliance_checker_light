...
class Document(BaseModel):
    ...
    # 兼容字段名（支持 path/file_path 和 name/file_name）
    path: str = Field(description="文件绝对路径", alias="file_path")
    name: str = Field(description="文件名", alias="file_name")
    type: DocType = Field(default=DocType.UNKNOWN, description="文件类型", alias="file_type")
