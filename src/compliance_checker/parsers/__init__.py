...
def parse_document(file_path: str, use_ocr: bool = True) -> Document:
    ...
    if doc_type == DocumentType.PDF:
        ...
        raise ValueError(".doc格式暂不支持，请先转换为.docx格式。" "可以使用LibreOffice或Microsoft Word进行转换。")
        ...
        return Document(
            ...
            pages=1,
            pages_content=[PageContent(page_num=0, text="", ocr_text=text, has_text_layer=False)],
